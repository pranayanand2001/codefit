...
import beginnerWorkouts from '../data/workouts/beginner.js'
...
const WorkoutParts = {
  abs: beginnerWorkouts.abs,
  arms: beginnerWorkouts.arms,
  legs: beginnerWorkouts.legs,
  chest: beginnerWorkouts.chest,
  shoulderAndBack: beginnerWorkouts.shoulderAndBack,
}
